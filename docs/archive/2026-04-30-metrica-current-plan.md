...
> **状态：已收口。** 本计划的 Runtime/App 贯通、WLS/HC1 结构化选项与数值可信度加固已经完成。诊断载荷计划（`2026-04-30-metrica-diagnostics-payload-plan.md`）也已完成。里程碑 2 全部完成。
...
- [x] **Step 2: 转发 `model_spec.vcov.type` 到 Julia**
...
- [x] **Step 1: 在请求构造中支持 `vcov` 与 `weights`**
